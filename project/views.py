...
def get_sensor_data(request, sensor_type, sensor_id, date):
    ...
    :return: JsonResponse - a json response containing the data for the given date - last updated date, minutely averages, hourly averages, hourly aqis, average data, aqi data
    :side effect: updates the cache with the fetched data
    """
    try:
        ### Test data
    ...
    minutely_avgs = data_fetcher.getMinutelyAverages(rawdata, date)
