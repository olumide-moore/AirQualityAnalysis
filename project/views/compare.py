...
@login_required
def get_data_for_date(request, sensor_type1, sensor_id1, sensor_type2, sensor_id2, date):
    """
...
@login_required
def get_data_across_dates(request, sensor_type1, sensor_id1, sensor_type2, sensor_id2, dates):
    """
